...
Tällä hetkellä trie-tietorakennetta testataan myös invarianttitesteillä. Invarianttitestit testaavat sanojen lisäystä ja etsintää satunnaisilla merkkijonoilla. Tämän hetken testeissä satunnaisia merkkijonoja testataan 500 eri merkkijonon testijoukolla.
